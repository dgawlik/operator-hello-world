...
* The original package name 'com.github.webpage-serving' is invalid and this project uses 'com.github.webpage_serving' instead.
...
```
$ docker run --rm -p 8080:8080 webpage-serving:0.0.1-SNAPSHOT
```
